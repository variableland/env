---
title: SSR / SSG
description: Server-rendered apps where the server has access to secrets and the browser receives only a public subset, injected into HTML via <EnvScript />.
icon: LayoutTemplate
---
